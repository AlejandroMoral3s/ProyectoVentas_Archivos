...
namespace PuntoDeVentas
{
    public class clientesSql
    {
        ...
        public string Insertar(clientesObj obj)
        {
            ...
            try
            {
                string sql = "Insert into Cliente (id_cliente, id_documento, id_municipio, nit_cliente, nombres, apellidos, direccion, telefono, fecha_nacimiento, fecha_ingreso) " +
                    "values (" + "'" + obj.id_cliente + "'," + "'" + obj.id_documento+ "'," + "'" + obj.id_municipio + "'," + "'" + obj.nit + "'," + 
        ...
        public string Actualizar(clientesObj obj)
        {
            ...
            try
            {
                string sql = "Update Cliente set id_documento = '"+obj.id_documento+"', id_municipio = '"+obj.id_municipio+ "', nombres = '" + obj.nombres + "', apellidos = '" + obj.apellidos +
